...
class Routes(PloneSandboxLayer):
    ...
    def setUpZope(self, app, configurationContext):
        ...
        z2.installProduct(app, 'collective.routes')

    def setUpPloneSite(self, portal):
        # install into the Plone site
        applyProfile(portal, 'collective.routes:default')
        setRoles(portal, TEST_USER_ID, ('Member', 'Manager'))
        workflowTool = getToolByName(portal, 'portal_workflow')
        workflowTool.setDefaultChain('plone_workflow')


Routes_FIXTURE = Routes()
Routes_INTEGRATION_TESTING = IntegrationTesting(
    bases=(Routes_FIXTURE,), name="Routes:Integration")
Routes_FUNCTIONAL_TESTING = FunctionalTesting(
    bases=(Routes_FIXTURE,), name="Routes:Functional")
